...
SERVICE_DESCRIPTIONS: Dict[str, str] = {
    ...
    "rpc_camera": "Robot main camera (Unitree RPC)",
    "depth_camera": "Intel RealSense depth camera",
    "local_camera": "Local webcam (OpenCV)",
    # Deprecated: keep echo state service disabled in /status output.
    # "state_echo": "Robot state via ros2 topic echo",
    "state_ros2": "Robot state via ROS2 subscriber node",
    "speaker": "Text-to-speech speaker",
    "audio_capture": "Microphone voice capture (hotword + ASR)",
